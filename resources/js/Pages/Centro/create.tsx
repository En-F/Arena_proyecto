...
export default function CreateCentro() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const camposObligatorios = [
            ...
            { id: 'es_activo', valor: data.es_activo, nombre: 'Estado' },
        ];
        ...
        post(route('centros.store'), { forceFormData: true });
    };
                ...
                <div className="cn-wrap">
                    ...
                    <div className="cn-actions mt-10">
                        ...
                        <Button
                            ...
                            disabled={processing}
                        >
                            {processing ? 'Guardando...' : 'Crear Centro'}
                        </Button>
                    </div>
                </div>
            </div>

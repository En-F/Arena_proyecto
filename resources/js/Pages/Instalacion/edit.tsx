...
export default function Edit({ instalacion, centros }: Props) {
    ...
    const { data, setData, post, processing, errors, setError, clearErrors } =
        useForm({
            ...
            imagen: null,
            centros_ids: instalacion.centros
                ? instalacion.centros.map((c) => c.id.toString())
                : [],
            _method: 'PUT',
        });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('instalaciones.update', instalacion.id), {
            preserveState: false,
            ...
            <div className="cn-page">
                <div className="cn-wrap">
                    <div className="cn-section-header">
                        <p className="cn-section-title">Editar Instalación</p>
                    </div>
